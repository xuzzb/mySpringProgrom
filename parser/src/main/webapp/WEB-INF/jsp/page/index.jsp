            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href="vertify"><i class="fa fa-book"></i> <span>novel</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li><a href="http://www.baidu.com">ClassicKongFUNovel</a></li>
                        <li><a href="tabs-accordions.html">UniversitySpringNovel</a></li>
                        <li><a href="typography.html">IndecentWifeNovel</a></li>
                        <li><a href="slider.html">laughJokeNovel</a></li>
                        <li><a href="panels.html">LongContentNovel</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href=""><i class="fa fa-cogs"></i> <span>video</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="grids.html">AsianHaveCodeVideo</a></li>
                        <li><a href="gallery.html">AsianNoCodeVideo</a></li>
                        <li><a href="calendar.html">AVStarVideo</a></li>
                        <li><a href="tree_view.html">ChineseNoCodeVideo</a></li>
                        <li><a href="nestable.html">ChineseThreeVideo</a></li>
                        <li><a href="nestable.html">EuropeNoCodeVideo</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href=""><i class="fa fa-envelope"></i> <span>GIF</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="mail.html">ColorGif</a></li>
                        <li><a href="mail_compose.html">ColorGroupGif</a></li>
                        <li><a href="mail_view.html">EvilGif</a></li>
                    </ul>
                </li>
